...
for folder in folders:
    ...
    deduplicate_one_sol_path = os.path.join(result_dir, folder, 'cassiopeia_greedy_deduplicate.tre')


    contract_path = os.path.join(result_dir, folder, 'cassiopeia_greedy_deduplicate_contract_sh.tre')
