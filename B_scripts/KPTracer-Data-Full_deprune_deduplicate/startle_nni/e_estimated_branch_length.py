...
def main():
    ...
    for folder in folders:
        ...
        one_sol_path = os.path.join(result_dir,folder, 'deduplicate.tre')
            
        one_sh_path = os.path.join(result_dir, folder, 'deduplicate_startle_nni_one_sol_sh_trees.nwk')


        trees = [one_sol_path, one_sh_path]

        method_name_map = {
            one_sol_path:'one_sol_branch_resolve_poly',
            one_sh_path: 'one_sol_sh_branch_resolve_poly'
        }
        
        for sh_tree in trees:
            method_name = method_name_map[sh_tree]
            print(method_name)
