...
result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/G_bio_result_pruned_deduplicate/startle_nni'
...
for folder in folders:
    ...
    contract_path = os.path.join(result_dir, folder, 'nni_tree_deduplicate_contract_sh.tre')
