...
for folder in folders:
    ...
    depruned_one_sol_path = os.path.join(result_dir, folder, 'paup_one_sol_depruned.tre')
   
    depruned_sc_path = os.path.join(result_dir, folder, 'paup_sc_depruned.tre')

    deduplicate_one_sol_path = os.path.join(result_dir, folder, 'paup_one_sol_deduplicate.tre')
    
    deduplicate_sc_path = os.path.join(result_dir, folder, 'paup_sc_deduplicate.tre')
