...
def main():
    ...
    result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/bio_result_deduplicate/laml'
    ...
    for folder in folders:
        ...
        all_paup_res_path = os.path.join(cur_res_path, 'laml_output_trees.nwk')
        replaced_back_all_tree_file = os.path.join(cur_res_path, 'replaced_laml_trees.nwk')
        eqclass_file = os.path.join(cur_data_path, folder + '_deduplicated_eqclass.json')
