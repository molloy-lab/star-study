...
data_path = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/result_data_in_startle/star_cdp'
...
for folder in folders:
    ...
    for rep in reps:
        ...
        # tar_tree= os.path.join(cur_data_rep_path, 'consensus_star_cdp_strict_consensus.tre')
        # res_tree = os.path.join(cur_res_rep_path, 'consensus_star_cdp_strict_consensus.tre')
