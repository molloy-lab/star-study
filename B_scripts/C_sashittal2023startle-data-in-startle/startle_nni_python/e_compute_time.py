...
def main():
    ...
    for folder in folders:
        ...
        cur_cplus_path = os.path.join(cplusplus_result_dir, folder)
        ...
        for rep in reps:
            ...
            cur_cplus_rep_path = os.path.join(cur_cplus_path, rep)
            ...
            print(data_prefix)
            nj_usage = os.path.join(cur_cplus_rep_path, 'nj_usage.log')
