...
def main():
    ...
    for folder in folders:
        ...
        # pruned_tree = os.path.join(cur_res_path, 'star_cdp-rand_one_sol.tre')
        ...
        # no_outg_tree_path = os.path.join(cur_res_path, 'removed_outg_star_cdp-rand_one_sol.tre')
        ...
        # replaced_tree_path = os.path.join(cur_res_path, 'replaced_star_cdp-rand_one_sol.tre')
