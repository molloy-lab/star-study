...
for folder in folders:
    ...
    # deduplicate_one_sol_path = os.path.join(result_dir, folder, 'removed_outg_star_cdp_sc_strict_consensus.tre')
    # contract_path = os.path.join(result_dir, folder, 'star_cdp_sc_sh.tre')
