...
def main():
    ...
    result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/bio_result_deduplicate/star_cdp'
    paup_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/bio_result_deduplicate/paup'
    ...
    for folder in folders:
        ...
        outgroup_camt_path = os.path.join(cur_res_path, folder + '_deduplicated_character_matrix_with_outg.csv')
