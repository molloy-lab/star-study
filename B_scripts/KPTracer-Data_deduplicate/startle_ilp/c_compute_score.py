...
def main():
    ...
    result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/bio_result_deduplicate/startle_ilp'
    ...
    for folder in folders:
        ...
        tree_path = os.path.join(cur_res_path, 'replaced_deduplicated_startle_tree.newick')
        data_prefix = folder + "/"
        print(data_prefix)
