...
def main():
    ...
    result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/bio_result_deduplicate/paup'
    ...
    for folder in folders:
        ...
        if not os.path.exists(all_paup_trees_path):
            ...
            one_nwk_file = os.path.join(cur_res_path, 'replaced_deduplicate_one_nwk.newick')
