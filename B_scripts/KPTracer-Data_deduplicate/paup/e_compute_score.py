...
parser.add_argument('one_nwk_file', type=str, help="one_nwk_file")
parser.add_argument('score_path', type=str, help="score_path")

args = parser.parse_args()
one_nwk_file = args.one_nwk_file
...
def main():
    ...
    for folder in folders:
        ...
        all_paup_trees_path = os.path.join(cur_res_path, 'replaced_deduplicated_paup.trees')
        ...
        if not os.path.exists(all_paup_trees_path):
            ...
            # one_nwk_file = os.path.join(cur_res_path, 'sc_sh_branch_trees.nwk')
            one_nwk_file = os.path.join(cur_res_path, one_nwk_file)
