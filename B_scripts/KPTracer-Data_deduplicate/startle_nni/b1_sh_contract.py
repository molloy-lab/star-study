...
result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/F_bio_result_deduplicate/startle_nni'
...
for folder in folders:
    ...
    deduplicate_one_sol_path = os.path.join(result_dir, folder, 'nni_tree.newick')
