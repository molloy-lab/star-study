...
all_result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/I_bio_result_Full_deduplicate'
...
for method in methods:
    for folder in folders:
        ...
        if not os.path.exists(os.path.join(result_dir,method)):
            os.mkdir(os.path.join(result_dir,method))
