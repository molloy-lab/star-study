...
def submit_laml_sbacth(sbatch: str, data_prefix: str, res_dir:str):
    ...
    os.chdir(res_dir)
    if os.path.exists(os.path.join(res_dir,'nni_tree.newick')):
...
def main():
    ...
    for folder in folders:
        ...
        if os.path.exists(os.path.join(cur_res_path, "nni_tree.newick")):
            write_laml_sbatch(cmat_path, priors_path, laml_sbatch, os.path.join(cur_res_path, "nni_tree.newick"), os.path.join(cur_res_path,'one_sol_branch_resolve_poly'))
