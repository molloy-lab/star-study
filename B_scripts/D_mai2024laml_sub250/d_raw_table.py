        ...
        for rep in reps:
            for method in methods:
                ...
                if method == 'ground-truth':
                    ...
                    cur_res_path = os.path.join(result_dir, method,f's{silencing}d{dropout}p{prior}_sub250_r{rep}')
                            
                    rf_file = os.path.join(cur_res_path, 'RF0.csv')
