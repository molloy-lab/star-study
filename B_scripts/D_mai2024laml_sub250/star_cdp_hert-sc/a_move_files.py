...
data_path = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/result_laml_sub250/star_cdp_hert'
...
for folder in folders:
    ...
    tar_RF = os.path.join(cur_data_path, 'consensus_RF.csv')
    res_RF = os.path.join(cur_res_path, 'RF.csv')
