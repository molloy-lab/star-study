...
def main():
    ...
    result_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/result_data_in_startle/star_cdp_hert-sc'
    ...
    for folder in folders:
        ...
        for rep in reps:
            ...
            star_cdp_tree_path = os.path.join(cur_res_rep_path, 'consensus_star_cdp_strict_consensus.tre')
