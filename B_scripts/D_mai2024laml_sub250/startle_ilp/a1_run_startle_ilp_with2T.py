...
def write_ilp_sbatch(curr_dir: str, ilp_exe: str, cmat: str, priors: str,sbatch_file: str):
    ...
    rows_to_wrtie = ['#!/bin/bash', 
                    ...
                    time + ' -v -o ' + usage_log_file + ' '+ perl + ' '+ ilp_exe + ' ' +\
                     '-o ' + output_dir + ' ' + '-m' + ' ' + priors + ' -c ' + cmat + ' --time-limit ' + '86400 ' + ' --threads ' + '16 '\
                      + ' &> ' +  log_file + ' 2>&1 '
                    ]
...
def main():
    ...
    folders = [f for f in folders if f.startswith('s50')]
    folders = [f for f in folders if f.endswith('r01')]
    print(folders)
    # ['s50d50p06_sub250_r01', 
    # 's50d50p05_sub250_r01', 
    # 's50d50p01_sub250_r01', 
    # 's50d50p04_sub250_r01', 
    # 's50d50p08_sub250_r01', 
    # 's50d50p09_sub250_r01', 
    # 's50d50p07_sub250_r01', 
    # 's50d50p02_sub250_r01', 
    # 's50d50p10_sub250_r01', 
    # 's50d50p03_sub250_r01']
