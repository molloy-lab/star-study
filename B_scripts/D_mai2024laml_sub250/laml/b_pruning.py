...
for folder in folders:
        ...
        print(cur_res_path)
        cur_tree_file = os.path.join(cur_res_path,'laml_output_trees.nwk')
        cur_seq_file = os.path.join(cur_res_path, 'laml_output_annotations.txt')
        cur_output_file = os.path.join(cur_res_path, 'contract_laml_tree.nwk')
