...
def main():
    ...
    paup_dir = '/fs/cbcb-lab/ekmolloy/jdai123/star-study/result_laml_sub250/paup_hert'
    ...
    for folder in folders:
        ...
        if not os.path.exists(os.path.join(cur_res_path, 'search_space.trees')) or True:
            print("process!")
