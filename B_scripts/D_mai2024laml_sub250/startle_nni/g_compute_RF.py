...
def main():
    ...
    for folder in folders:
        ...
        tree_path = os.path.join(cur_res_path, 'nni_tree.newick')
        ...
        if not os.path.exists(score_path) or True:
            ...
            score_res = sp.run(['python3', comp_exe, '-t1', true_tree_path, '-t2', tree_path, '-c1','0', '-c2', '0', '-m', cmat_path], capture_output=True, text=True)
