...
def make_figure(df, output, nlin):
    if nlin == 50:
            ...
            for k, mthd in enumerate(mthds):
                ...
                if i == 0:
                    ...
                    if nlin == 50:
                        ...
                        ydraws = [0, 2.5, 5, 7.5, 10, 12.5, 15, 17.5, 20, 22.5, 25, 27.5, 30, 32.5, 35]
                    elif nlin == 100:
                        yticks = [0, 10, 20, 30, 40, 50, 60]
                        ydraws = [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60]
                    elif nlin == 150:
                        yticks = [0, 15, 30, 45, 60, 75, 90]
                        ydraws = [0, 7.5, 15, 22.5, 30, 37.5, 45, 52.5, 60, 67.5, 75, 82.5, 90]
                    else:
                    ...
                    if nlin == 50:
                        yticks = [0, 5, 10, 15, 20]
                        ydraws = [0, 2.5, 5, 7.5, 10, 12.5, 15, 17.5, 20]
                    elif nlin == 100:
                        yticks = [0, 5, 10, 15, 20, 25, 30, 35]
                        ydraws = [0, 2.5, 5, 7.5, 10, 12.5, 15, 17.5, 20, 22.5, 25, 27.5, 30, 32.5, 35]
                    elif nlin == 150:
                        yticks = [0, 10, 20, 30, 40, 50]
                        ydraws = [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50]
                    else:
                        yticks = [0, 10, 20, 30, 40, 50, 60]
                        ydraws = [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60]
                elif i == 2:
                    ...
                    if nlin == 50:
                        ...
                        ydraws = [0, 2.5, 5, 7.5, 10, 12.5, 15, 17.5, 20, 22.5, 25, 27.5, 30, 32.5, 35, 37.5, 40]
                    elif nlin == 150:
                        yticks = [0, 10, 20, 30, 40, 50, 60]
                        ydraws = [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60]
                    else:
...
for nlin in [50, 100, 150, 200]:
    make_figure(df, str("startle-sim-supp-nlin-%d.pdf" % nlin), nlin)
