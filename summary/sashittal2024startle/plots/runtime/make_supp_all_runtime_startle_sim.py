...
def make_figure(df, output):
    ...
    for i in range(len(grid)):
        ...
        # Y ticks
        if i == 0:
            yticks = [x for x in range(0, 17, 4)]
            ydraws = [x for x in range(0, 17, 2)]
        elif i == 1:
            yticks = [x for x in range(0, 141, 20)]
            ydraws = [x for x in range(0, 141, 10)]
        elif i == 2:
            yticks = [x for x in range(0, 401, 100)]
            ydraws = [x for x in range(0, 401, 50)]
        else:
            yticks = [x for x in range(0, 1101, 100)]
            ydraws = [x for x in range(0, 1101, 100)]
        #ymin = ydraws[0]
        #ymax = ydraws[-1]
...
make_figure(df, "startle-sim-supp-all-runtime.pdf")
